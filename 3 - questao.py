...
print(f'faxetaria 5 (até acima de 60 anos ): {faixetaria5}')

print(f'A porcentagem de pessoas de 15 anos:{faixetaria1/8*100}%')
print(f'A porcentagem de pessoas acima de 60 anos:{faixetaria5/8*100}%')
